    ...
    <div className="container">
      <div className="row">
        <div className="col-lg-12">
          ...
          Design: <a href="https://tiedun46.github.io/user-ntd/?fbclid=IwAR0Ok-RhFfeWl-VavA3D7f9Pz3emFDr0vF21egsoKHBeeS5dbMzd0xdVYOY" target="_blank" rel="noreferrer">Quang Huy</a></p>
        </div>
      </div>
